...
/*   Updated: 2025/03/14 18:33:28 by jcaro-lo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_map	*init_map(t_map *game)
{
	...
	game->images.player_up = NULL;
	game->images.player_down = NULL;
	game->images.player_left = NULL;
	game->images.player_right = NULL;
	game->images.wall = NULL;
	game->images.oponent = NULL;
	game->images.show_moves = NULL;
	game->window = NULL;
	return (game);
}
