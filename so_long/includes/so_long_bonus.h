...
# define ERR_STR "The string could not be allocated"
...
typedef struct s_map
{
	...
	int			height;
	int			width;
	int			count_p;	//IT COUNTS THE PLAYER
	int			count_e;	//IT COUNTS THE EXIT
	int			count_c;	//IT COUNTS THE COLLETIBLES
	int			count_o;	//IT COUNTS THE OPONENTS
	int			moves;
	t_coord		p_pos;
	t_images	images;
	mlx_t		*window;
